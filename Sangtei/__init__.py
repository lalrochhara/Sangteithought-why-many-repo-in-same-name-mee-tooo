...
def get_user_list(__init__, key):
    with open("{}/Sangtei/{}".format(os.getcwd(), __init__), "r") as json_file:
...
LOGGER.info("Sangtei is starting. | An Sangtei Parts. | Licensed under GPLv3.")
...
if ENV:
    ...
    MONGO_DB = os.environ.get("MONGO_DB", "Sangtei Mega")
...
try:
    from Sangtei.antispam import antispam_restrict_user, antispam_cek_user, detect_user
