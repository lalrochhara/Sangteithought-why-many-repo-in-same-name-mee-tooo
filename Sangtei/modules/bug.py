...
from Sangtei import pbot as Client
from Sangtei import (
    OWNER_ID as owner,
    SUPPORT_CHAT as log,
)
...
async def bug(_, msg: Message):
    ...
    thumb = "https://imgtr.ee/images/2023/08/04/99e538ba276e281257b8116038af9d3c.png"
    
    bug_report = f"""
**#BUG : ** **[Nicky Lalrochhara](https://t.me/NickyLrca)**
**From User : ** **{mention}**
**User ID : ** **{user_id}**
**Group : ** **{chat_username}**
**Bug Report : ** **{bugs}**
