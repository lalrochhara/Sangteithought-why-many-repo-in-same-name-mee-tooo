...
async def _(event):
    ...
    im1 = Image.open("Sangtei/resources/Sangtei.png")
    if ik.endswith(".tgs"):
        await tbot.download_media(reply, "Sangtei.tgs")
        os.system("lottie_convert.py Sangtei.tgs json.json")
        json = open("json.json", "r")
        jsn = json.read()
        jsn = jsn.replace("512", "2000")
        open = ("json.json", "w").write(jsn)
        os.system("lottie_convert.py json.json Sangtei.tgs")
        file = "Sangtei.tgs"
        os.remove("json.json")
