...
from Sangtei.services.telethonbasics import is_admin
from Sangtei.events import register
from pymongo import MongoClient
from Sangtei.modules.sql.nsfw_watch_sql import (
    add_nsfwatch,
    get_all_nsfw_enabled_chat,
    is_nsfwatch_indb,
    rmnsfwatch,
)
from Sangtei import telethn as tbot, MONGO_DB_URI, BOT_ID
