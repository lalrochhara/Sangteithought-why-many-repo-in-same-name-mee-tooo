...
from Sangtei.modules.helper_funcs.decorators import Sangteicmd, Sangteimsg
from Sangtei.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from Sangtei.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@Sangteicmd(command="antich", group=100)
...
@Sangteimsg(Filters.chat_type.groups, group=110)
