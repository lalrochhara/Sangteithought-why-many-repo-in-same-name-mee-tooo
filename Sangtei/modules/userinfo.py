...
from Sangtei.modules.sql.afk_sql import is_afk, set_afk
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/NickyLrca"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/NickyLrca")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/SangteiUpdates"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/SangteiUpdates")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
