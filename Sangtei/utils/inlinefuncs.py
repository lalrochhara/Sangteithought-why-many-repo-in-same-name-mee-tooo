...
from Sangtei import arq
from Sangtei.services.keyboard import Ikb
from Sangtei.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Sangtei.services.tasks import _get_tasks_text, all_tasks, rm_task
from Sangtei.services.types import InlineQueryResultCachedDocument
from Sangtei.modules.info import get_chat_info, get_user_info
from Sangtei.modules.music import download_youtube_audio
from Sangtei.utils.functions import test_speedtest
from Sangtei.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://imgtr.ee/images/2023/08/04/99e538ba276e281257b8116038af9d3c.png",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Sangtei"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Sangtei](https://t.me/Sangtei):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [Nicky Lalrochhara🪐](t.me/NickyLrca)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    chat_id = -1001826367325
    group_invite = "https://t.me/SangteiSupport"
    try:
        messages = [
            m
...
async def cancel_task_button(_, query: CallbackQuery):
    ...
    if user_id not in DEV_USERS:
        return await query.answer("I tana siam ani leuh.")
